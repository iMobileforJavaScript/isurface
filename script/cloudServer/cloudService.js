...
export default class CloudService extends React.Component {

  render() {
    const imagePath = this.props.image ? this.props.image : require('../../image/avatar.png');
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={styles.btnImage} onPress={btnClick} underlayColor={Util.UNDERLAYCOLOR}>
          <Image style={styles.btnImage} source={require('../../image/arrow-right.png')} />
        </TouchableHighlight>
      </View>
    );
  }
